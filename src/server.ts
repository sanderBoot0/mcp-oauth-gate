...
import { PORT, BASE_URL, AUTH_PATH_PREFIX, RESOURCE_URL, AUTH_PROVIDER, ALLOWED_EMAILS } from './env.js';
...
const provider: Provider = AUTH_PROVIDER === 'github' ? githubProvider : oidcProvider;
...
async function main(): Promise<void> {
    ...
    app.listen(PORT, '0.0.0.0', () => {
        console.error(`[server] mcp-oauth-gate listening on :${PORT}, provider=${AUTH_PROVIDER}, redirect_uri=${REDIRECT_URI}`);
    });
}
